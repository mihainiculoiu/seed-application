package com.veracityid.assignment.web.config;

import com.veracityid.assignment.web.api.ErrorResponse;
...
@Configuration
@OpenAPIDefinition(info = @Info(title = "Assignment API",
        description = "Application that provides API for Assigment",
        license = @License(name = "Assignment API", url = "https://assignemnt-application.index.html"),
        version = "1.0",
